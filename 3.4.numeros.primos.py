#3.4 Escriba un algoritmo que proporcione los números primos comprendidos entre 1 y 1000. Recuerde que un numero primo solo es divisible entre
#si mismo y por la unidad. Preste atencion, lo más sencillo no siempre es lo más rápido.
